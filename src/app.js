...
app.options("*", cors({ origin: ['http://localhost:19006',  'http://localhost:8082','https://fluffy-tarsier-c3f7df.netlify.app', "https://marvel-backend-vzsr.onrender.com"], optionsSuccessStatus: 200 }));
